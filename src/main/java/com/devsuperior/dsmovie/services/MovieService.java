...
public class MovieService {
	...
	public Page<MovieDTO> findAll(String title, Pageable pageable) {
		...
		return result.map(x -> new MovieDTO(x).add(linkTo(methodOn(MovieController.class).findAll(null, null)).withSelfRel().expand())
	...
	public MovieDTO findById(Long id) {
		...
		MovieDTO dto = new MovieDTO(result)
				...
				.add(linkTo(methodOn(MovieController.class).findAll(null, null)).withRel("All movie").expand())
